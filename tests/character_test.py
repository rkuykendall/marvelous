...
class TestCharacters(unittest.TestCase):
    ...
    def test_known_character(self):
        ...
        self.assertTrue(cap.resource_uri == "http://gateway.marvel.com/v1/public/characters/1009220")
        self.assertTrue(cap.thumbnail == "http://i.annihil.us/u/prod/marvel/i/mg/3/50/537ba56d31087.jpg")
