...
class TestSeries(unittest.TestCase):
    ...
    def test_known_series(self):
        ...
        self.assertEqual('http://i.annihil.us/u/prod/marvel/i/mg/6/c0/5149db8019dc9.jpg',
                         usms.thumbnail)
        self.assertEqual(2009, usms.endYear)
        self.assertEqual(2000, usms.startYear)
        self.assertEqual(datetime.datetime(2013, 3, 20, 11, 54, 44,
                                           tzinfo=datetime.timezone(
                                               datetime.timedelta(
                                                   days=-1, seconds=72000))),
                         usms.modified)
        self.assertEqual("In 2000, Marvel embarked on a bold new experiment, "
    ...
    def test_all_series(self):
        ...
        seriesType = 'ongoing'
        startYear = 2009
        series_iter = self.m.series(params={'seriesType':seriesType,
                                            'startYear' : startYear,
                                            'limit':10})
